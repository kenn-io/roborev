...
2. Validate any supplied commit with Git and pass it as a positional
   argument. Without a commit, review HEAD.
...
3. Start the authorized review with `roborev review --type lookahead` and the
