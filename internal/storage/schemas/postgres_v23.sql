-- PostgreSQL schema v23. Adds review_jobs.non_voting: an advisory panel member
-- that is stored and labeled but excluded from synthesis and the verdict.
...
CREATE TABLE IF NOT EXISTS roborev.review_jobs (
  ...
  non_voting BOOLEAN NOT NULL DEFAULT FALSE,
  skip_reason TEXT,
  source TEXT,
  panel_run_uuid TEXT,
  panel_role TEXT,
