...
- [x] **Step 2: Implement config fields and resolver**
...
- [x] **Step 2: Implement commit options**
...
- [x] **Step 3: Verify git tests pass**
  - Run: `go test ./internal/git -run 'TestCreateCommit.*(Author|CoAuthor|Trailer|Hook)' -count=1`
  - Expected: PASS.
...
- [x] **Step 2: Implement prompt helper and thread metadata**
...
- [x] **Step 3: Verify command prompt tests pass**
  - Run: `go test ./cmd/roborev -run 'Test.*CommitMetadata.*Prompt|TestBuild.*Prompt' -count=1`
  - Expected: PASS.
...
- [x] **Step 3: Verify wiring tests pass**
