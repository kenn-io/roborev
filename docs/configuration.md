...
auto_filter_repo = false          # Show all repos in the TUI on startup (default: current repo)
auto_filter_branch = false        # Show all branches in the TUI on startup (default: current branch)
...
| `auto_filter_repo` | bool | true | Auto-filter TUI to the current repo on startup | N/A |
| `auto_filter_branch` | bool | true | Auto-filter TUI to the current branch/worktree on startup | N/A |
